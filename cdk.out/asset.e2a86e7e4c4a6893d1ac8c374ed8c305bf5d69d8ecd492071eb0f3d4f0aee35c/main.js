...
/***/ "./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/client.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/client.js ***!
  \*************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
const helper = __webpack_require__(/*! ./clientHelper */ "./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/clientHelper.js");
...
/***/ "./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/clientHelper.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/clientHelper.js ***!
  \*******************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
const constants = __webpack_require__(/*! ./constants */ "./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/constants.js");
...
/***/ "./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/constants.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/constants.js ***!
  \****************************************************************************/
/***/ ((module) => {
...
/*!******************!*\
  !*** ./index.js ***!
  \******************/
const amazonPay = __webpack_require__(/*! @amazonpay/amazon-pay-api-sdk-nodejs */ "./node_modules/@amazonpay/amazon-pay-api-sdk-nodejs/src/client.js");
const DynamoDB = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'aws-sdk/clients/dynamodb'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
...
const updateSignatureOnDynamoDB = async (task, item) => {
  const params = {
    TableName: ADMINS_TABLE,
    Key: {},
...
exports.handler = async (event) => {
  ...
  const { publicKeyId, privateKey, amazonPayStoreId } = response.Item
  ...
  try {
    await updateSignatureOnDynamoDB({ [AMAZON_PAY_SIGNATURE_KEY]: signature }, response.Item);
