...
const main = async (event, context, callback) => {
  ...
  if (productType === "LIGHTING_DEAL") {
    ...
    const lightingDealPrice = task.lightingDealPrice
    ...
    dynamodbParams.Item.LIGHTING_DEAL_PRICE = { S: lightingDealPrice }
  }
  ...
  tags.forEach((tag) => {
    ...
    docClient.update(updateTagsParams, function (error, data) {
      if (error) {
        console.error(error)
