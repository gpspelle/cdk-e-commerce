...
const main = async (event) => {
  ...
  try {
    ...
    console.error(error)
    return handleError({ message: "Erro ao inserir item no dynamodb " })
  }
  ...
  try {
    ...
    console.error(error)
    return handleError({ message: "Erro ao adicionar produto na tabela de tags" })
  }
  ...
  try {
    ...
    console.error(error)
    return handleError({ message: "Erro ao adicionar imagem no s3 bucket" })
  }
  ...
  try {
    ...
    console.error(error)
    return handleError({ message: "Erro ao adicionar imagem redimensionada no s3 bucket" })
  }
