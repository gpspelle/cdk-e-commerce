...
const DynamoDB = __webpack_require__(6254)
...
Object.defineProperty(apiLoader.services['dynamodb'], '2012-08-10', {
  get: function get() {
    var model = __webpack_require__(4047);
...
Object.defineProperty(apiLoader.services['sts'], '2011-06-15', {
  get: function get() {
    ...
    model.paginators = (__webpack_require__(6314)/* .pagination */ .o);
    return model;
  },
  enumerable: true,
  configurable: true
...
var AWS = __webpack_require__(9614);
var proc = __webpack_require__(2081);
...
var EventMessageChunkerStream = (__webpack_require__(2697).EventMessageChunkerStream);
var EventUnmarshallerStream = (__webpack_require__(7354).EventUnmarshallerStream);
  ...
  Logger: new SequentialExecutor().addNamedListeners(function(add) {
    add('LOG_REQUEST', 'complete', function LOG_REQUEST(resp) {
      ...
      function buildMessage() {
        ...
        var params = (__webpack_require__(3837).inspect)(censoredParams, true, null);
        var message = '';
...
AWS.NodeHttpClient = AWS.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
    ...
    var http = useSSL ? __webpack_require__(5687) : __webpack_require__(3685);
    var options = {
...
__webpack_require__(6344);
var inherit = AWS.util.inherit;
var getMetadataServiceEndpoint = __webpack_require__(4686);
var URL = (__webpack_require__(7310).URL);
...
var EndpointMode = __webpack_require__(6382)();
...
var Endpoint = __webpack_require__(6896)();
var EndpointMode = __webpack_require__(6382)();

var ENDPOINT_CONFIG_OPTIONS = __webpack_require__(8170)();
var ENDPOINT_MODE_CONFIG_OPTIONS = __webpack_require__(3428)();
...
util.crypto.lib = __webpack_require__(6113);
util.Buffer = (__webpack_require__(4300).Buffer);
util.domain = __webpack_require__(3639);
util.stream = __webpack_require__(2781);
util.url = __webpack_require__(7310);
util.querystring = __webpack_require__(3477);
util.environment = 'nodejs';
util.createEventStream = util.stream.Readable ?
  (__webpack_require__(8621).createEventStream) : (__webpack_require__(2403).createEventStream);
util.realClock = __webpack_require__(3790);
util.clientSideMonitoring = {
  Publisher: (__webpack_require__(3720).Publisher),
  configProvider: __webpack_require__(9317),
};
util.iniLoader = (__webpack_require__(4554)/* .iniLoader */ .b);
util.getSystemErrorName = (__webpack_require__(3837).getSystemErrorName);
 ...
 * @api private
 */
module.exports = AWS = __webpack_require__(9614);
...
AWS.XML.Parser = __webpack_require__(7712);
...
var IniLoader = (__webpack_require__(6458).IniLoader);
/**
...
var util = {
  ...
  readFileSync: function readFileSync(path) {
    ...
    return (__webpack_require__(7147).readFileSync)(path, 'utf-8');
  },
  ...
  string: {
    byteLength: function byteLength(string) {
      ...
      if (typeof string.byteLength === 'number') {
        ...
        return (__webpack_require__(7147).lstatSync)(string.path).size;
      } else {
  ...
  uuid: {
    v4: function uuidV4() {
      return (__webpack_require__(5877).v4)();
    }
  },
...
(function() {
  ...
  ref = __webpack_require__(8369), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;
...
(function() {
  ...
  ref = __webpack_require__(8369), isObject = ref.isObject, isFunction = ref.isFunction;
...
(function() {
  ...
  ref = __webpack_require__(8369), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
/******/ 	module.exports.fuck = __webpack_exports__;
/******/ 	
/******/ })()
;