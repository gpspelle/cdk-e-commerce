...
const main = async (event, context, callback) => {
    ...
    try {
        ...
        const allowAllApiEndpointsArn = "arn:aws:execute-api:us-east-1:453299922179:qbhf2c9996/dev/*";
        callback(null, generatePolicy("user", "Allow", allowAllApiEndpointsArn, payload.id));
    } catch (error) {
